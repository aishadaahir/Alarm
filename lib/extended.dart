    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return  AlertDialog(
          icon: Row(
            children: [
              Icon(Icons.access_alarm,color: Colors.purple,size: 30,),
          ...
          actions: [
            Center(
              child: ElevatedButton(
                  child: Text("dismiss",style: TextStyle(fontSize: 30),),
                  onPressed: () {
        ...
        headerSliverBuilder:(cpntext,innerBoxIsScrolled)=>[
          SliverAppBar(
            ...
            flexibleSpace: StreamBuilder<QuerySnapshot>(
                stream:FirebaseFirestore.instance.collection("alarm").where("status",isEqualTo: true).snapshots(),
